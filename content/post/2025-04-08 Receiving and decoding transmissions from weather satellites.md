...
Today, an SDR USB dongle paired with software with [SDR++](https://www.sdrpp.org/) and [SatDump](https://www.satdump.org/) can process and decode into human viewable results basically any kind of satellite broadcast known to amateur radio enthusiasts.
